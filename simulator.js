...
function warpSim(copies) {
    const percentages = [0.0081, 0.0079, 0.0083, 0.0078, 0.0085, 0.0084, 0.0084, 0.0081, 0.0082, 0.0086, 
    ...
    const fpercentages = [0.0514, 0.0485, 0.0463, 0.0463, 0.0414, 0.0393, 0.0374, 0.0353, 0.03686, 0.2844, 1.000]; 
